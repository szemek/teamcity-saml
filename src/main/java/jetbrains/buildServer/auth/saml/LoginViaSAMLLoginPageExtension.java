...
public class LoginViaSAMLLoginPageExtension extends SimplePageExtension {


    @NotNull
    private final AuthenticationSchemeProperties schemeProperties;

    public LoginViaSAMLLoginPageExtension(@NotNull final PagePlaces pagePlaces,
                                           @NotNull final PluginDescriptor pluginDescriptor,
                                           @NotNull final AuthenticationSchemeProperties schemeProperties) {
        super(pagePlaces,
                PlaceId.LOGIN_PAGE,
                LoginViaSAMLLoginPageExtension.class.getName(),
    ...
    public void fillModel(@NotNull Map<String, Object> model, @NotNull HttpServletRequest request) {
        ...
        model.put("saml_settings", schemeProperties);
    }
}
